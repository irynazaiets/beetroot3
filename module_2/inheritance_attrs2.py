...
class Car(Vehicle):
    def __init__(self, make, model, seats):
        super().__init__(make, model)  # Викликаємо конструктор батьківського класу
        self.seats = seats  # Додаємо новий атрибут
...
class Truck(Vehicle):
    def __init__(self, make, model, capacity):
        super().__init__(make, model)  # Викликаємо конструктор батьківського класу
        self.capacity = capacity  # Додаємо новий атрибут
